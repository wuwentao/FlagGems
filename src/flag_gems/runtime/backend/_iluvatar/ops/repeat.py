...
@triton.autotune(
    configs=[
        ...
        triton.Config({"BLOCK_M": 16, "BLOCK_N": 512}, num_warps=8, num_stages=1),
...
@triton.autotune(
    configs=[
        ...
        triton.Config({"BLOCK_N": 2, "BLOCK_K": 1024}, num_warps=4, num_stages=1),
        triton.Config({"BLOCK_N": 4, "BLOCK_K": 512}, num_warps=4, num_stages=1),
    ],
